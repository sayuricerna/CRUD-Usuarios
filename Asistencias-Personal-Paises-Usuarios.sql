...
/****** Object:  Database [Asistencias]    Script Date: 1/14/2025 5:47:11 PM ******/
CREATE DATABASE [Asistencias]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Asistencias', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Asistencias.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Asistencias_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Asistencias_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Asistencias] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [Asistencias] SET RECOVERY SIMPLE 
GO
